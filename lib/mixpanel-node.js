    ...
    */
    ...
    metrics.people = {
        ...
        */
        ...
        /**
            people.get_user(distinct_id, callback)
            ---
            gets an user record in engage

            usage:

                mixpanel.people.get_user('bob');
        */
        get_user: function(distinct_id, callback) {
            var data = {
                '$token': metrics.token,
                '$distinct_id': distinct_id
            };
            ...
            if(metrics.config.debug) {
                console.log("Getting the user from engage:", distinct_id);
            }
